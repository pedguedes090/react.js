...
import { fetchStudent,addStudent,updateStudent,deleteStudent} from './slice/Student.slice';
...
const App: React.FC = () => {
  ...
  const handleSubmit = (data: {
    ...
    if (data.id) {
      ...
      dispatch(addStudent({ id, name: data.name, age: data.age, grade: data.grade }));
    }
    setOpenForm(false);
  };
